...
public class Player : MonoBehaviour 
{
	...
	void FireBall()
	{
		GameObject _ball = Instantiate(ball, transform.position + Vector3.forward, transform.rotation) as GameObject;
	...
	void simulatePath(float strength)
	{
		...
		_temp.transform.position = transform.position + Vector3.forward;
